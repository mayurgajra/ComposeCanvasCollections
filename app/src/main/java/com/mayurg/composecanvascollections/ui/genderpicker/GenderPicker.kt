...
fun GenderPicker(
    ...
    val maleSelectRadius = animateFloatAsState(
        targetValue = if (selectedGender is Gender.Male) 80f else 0f,
        animationSpec = tween(durationMillis = 500)
    )

    val femaleSelectRadius = animateFloatAsState(
                ...
                clipPath(
                    ...
                    drawCircle(
                        brush = Brush.radialGradient(
                            ...
                            radius = maleSelectRadius.value + 1f
                        ),
                        radius = maleSelectRadius.value,
                        center = untransformedMaleClickOffset
                    )
                }
            }
                ...
                clipPath(
                    ...
                    drawCircle(
                        brush = Brush.radialGradient(
                            ...
                            radius = femaleSelectRadius.value + 1f
                        ),
                        radius = femaleSelectRadius.value,
                        center = untransformedFemaleClickOffset
                    )
                }
            }
